# REPORTE T0-B — Reconciliación de cajas · PRODUCCIÓN

> **Harness READ-ONLY sobre PRODUCCIÓN.** Cero INSERT/UPDATE/DELETE, cero migraciones, cero cambios de esquema.
...
| 15 | `2026-07-21` | ₡ 5,00 | — | — | — | ₡ 5,00 | ✅ CUADRÓ |
...
|---|---|---|---|---|---|---|---|
| `Banco` | `Transferencia` | `egreso_mercaderia` | aprobado | 31 | ₡ 1.405.101,87 | $ 0,00 | — |
| `Banco` | `Transferencia` | `egreso_mercaderia` | pendiente | 6 | ₡ 345.364,29 | $ 0,00 | — |
...
|---|---|---|---|---|
| `ingreso` | `Caja Fuerte` | Ventas cierre | 10 | −₡ 395.316,88 |
| `ingreso` | `Caja Fuerte` | (null) | 5 | −₡ 56.369,78 |
| `traspaso` | `Registradora` | (null) | 6 | −₡ 15.897,00 |

Total: **21** movimiento(s), Σ −₡ 467.583,66.
...
**Qué se fue a verificar:** El dueño remedió a mano el **caso Ronny** (SOP interino): recategorizó el egreso a `Caja Fuerte`. Hay que ver con qué caja quedó el movimiento hoy y cómo terminó clasificando el cierre del día.

**Turnos de ese día**

| id | shift_type | status | cajero | `initial_suppliers_crc` | creado | último cambio | `closed_by` |
|---|---|---|---|---|---|---|---|
| `d707c7e6` | Día | **closed** | AMPI | ₡ 100.000,00 | `2026-07-22 03:53:27` | `2026-07-22 05:16:47` | `c10f2ddf` |

> ✅ **Ninguna caja de esta fecha quedó abierta.** Está en `closed`; el último cambio quedó registrado el `2026-07-22 05:16:47`. La tabla no guarda el estado anterior: esto dice cómo está HOY, no si alguna vez estuvo abierta.

**Cómo quedó el cierre:** diferencia ₡ 5,00 → ✅ **CUADRÓ**. Egresos de Caja Proveedores en efectivo de ese día: ₡ 0,00 (0 mov.).

**Movimientos del día (9)**

| id | tipo | caja_origen | método | subcategory | descripción | monto | status |
|---|---|---|---|---|---|---|---|
| `a9455e94` | `egreso_personal` | `Registradora` | Efectivo | Propinas por turno | Propinas turno 2026-07-21 Mediodía | ₡ 6.000,00 | aprobado |
| `b33ae5be` | `egreso_mercaderia` | `Banco` | Transferencia | Proveedor mercadería | 4015 · fact 2026-07-21 | ₡ 27.511,03 | pendiente |
| `3557084b` | `egreso_mercaderia` | `Caja Fuerte` | Efectivo | Proveedor mercadería | 4188 · fact 2026-07-21 | ₡ 45.520,00 | aprobado |
| `68fcb958` | `egreso_mercaderia` | `Banco` | Transferencia | Proveedor mercadería | 5516 · fact 2026-07-21 | ₡ 51.290,00 | pendiente |
| `21675433` | `egreso_mercaderia` | `Banco` | Transferencia | Proveedor mercadería | 2575 · fact 2026-07-21 | ₡ 67.280,00 | pendiente |
| `8089558f` | `egreso_mercaderia` | `Banco` | Transferencia | Proveedor mercadería | 3851 · fact 2026-07-21 | ₡ 109.879,45 | pendiente |
| `636c8aef` | `egreso_personal` | `Registradora` | Efectivo | Propinas por turno | Propinas turno 2026-07-21 Noche | ₡ 27.850,00 | aprobado |
| `2277c75c` | `ingreso` | `Caja Fuerte` | Efectivo | Ventas cierre | Ventas efectivo Noche 2026-07-21 | ₡ 5.200,00 | aprobado |
| `8a67eece` | `ingreso` | `Caja Fuerte` | Efectivo | Ventas cierre | Ventas efectivo Mediodía 2026-07-21 | −₡ 30.560,00 | aprobado |
...
|---|---|---|---|---|---|---|
| `3557084b` | **`Caja Fuerte`** | Efectivo | ₡ 45.520,00 | `2026-07-22 03:58:00` | `2026-07-22 05:29:44` | 1h 31m |
| `636c8aef` | **`Registradora`** | Efectivo | ₡ 27.850,00 | `2026-07-22 04:57:37` | `2026-07-22 05:02:27` | 4m 50s |

### 4.2 · `2026-07-14`

**Qué se fue a verificar:** El DIAGNÓSTICO anotó una **caja vieja abierta** de esta fecha en prod. Confirmar o descartar con datos: si el turno existe, en qué `status` está hoy.

**Turnos de ese día**

| id | shift_type | status | cajero | `initial_suppliers_crc` | creado | último cambio | `closed_by` |
|---|---|---|---|---|---|---|---|
| `51c71ff2` | Día | **closed** | AMPI | ₡ 100.000,00 | `2026-07-21 14:29:00` | `2026-07-21 21:20:45` | `48ef8af5` |

> ✅ **Ninguna caja de esta fecha quedó abierta.** Está en `closed`; el último cambio quedó registrado el `2026-07-21 21:20:45`. La tabla no guarda el estado anterior: esto dice cómo está HOY, no si alguna vez estuvo abierta.

**Cierre:** no hay fila de `cash_cierres_dia` con esa fecha.

**Movimientos del día (0)**

_Ninguno._

_Ningún movimiento de ese día tiene `updated_at` posterior al `created_at`._
