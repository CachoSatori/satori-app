...
> **Handoff: 2026-06-28 (continuación — CI/infra + 1 fix de plata client-side). SIN esquema, SIN datos.** CI/infra (Actions @v5/Node 24 en main+staging, `.temp/` untrackeado en main, 2 ramas de prep borradas) **+ se cerró el Hallazgo B** (drain del outbox en `SIGNED_IN`, client-side). **`main` = `52d1475`** · **`staging` = `492eaa5`**.
>
